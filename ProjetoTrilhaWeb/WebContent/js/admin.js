...
$(document).ready(function() {
	...
	//Função para carregamento de páginas de conteúdo, que recebe como parâmetro
	// o nome da pasta com a página a ser carregada
	
	COLDIGO.carregaPagina = function(pagename){
		//Remove o conteúdo criado na abertura de uma janela modal pelo jQueryUI
		if($(".ui-dialog"))
		   $(".ui-dialog").remove();
		//Limpa a tag section, excluindo todo o conteúdo de dentro da tag section
		$("section").empty();
