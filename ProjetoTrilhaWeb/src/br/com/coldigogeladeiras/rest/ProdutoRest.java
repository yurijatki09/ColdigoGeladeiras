...
public class ProdutoRest extends UtilRest {
	...
	public Response inserir(String produtoParam) {
		...
		try {
			...
			String msg = "";
			boolean verificaMarca = jdbcProduto.verificaMarca(produto.getMarcaId());
			if(verificaMarca==false) {
				
				boolean verificaModelo = jdbcProduto.verificaModelo(produto);
				if(verificaModelo) {
				...
				msg = "Marca não existente! Atualize a página para ver os registros de marcas atuais.";
				conec.fecharConexao();
				return this.buildErrorResponse(msg);
			}
